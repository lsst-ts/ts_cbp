...
class TestCbpComponent:
    ...
    def cbp(self):
        cbp = CBPComponent("",5000,simulation_mode=True)
        cbp.socket = Mock()
        return cbp
    ...
    @pytest.mark.parametrize("mask_float, expected_name", [("1.0","Not a mask 1"),("2.0","Not a mask 2"),("3.0","Not a mask 3"),("4.0","Not a mask 4"),("5.0","Not a mask 5"),("9.0","Unknown Mask")])
    ...
    @pytest.mark.parametrize("mask_name,mask_float",[("Not a mask 1",b"new_msk=1.000000"),("Not a mask 2",b"new_msk=2.000000"),("Not a mask 3",b"new_msk=3.000000"),("Not a mask 4",b"new_msk=4.000000"),("Not a mask 5",b"new_msk=5.000000"),("Unknown Mask",b"new_msk=9.000000")])
